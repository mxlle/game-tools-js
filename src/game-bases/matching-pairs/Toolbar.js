...
export class Toolbar {
    ...
    constructor(numOfCards, currentHighScore) {
        ...
        const statisticsElement = createElement({cssClass: 'game-toolbar-statistics', text: `Best score: ${currentHighScore ?? '-'}, Lucky score: ${numOfCards}, Unlucky score: ${numOfCards * 2}, Troll score: ${numOfCards * 3}`});
